...
describe('String Generator', () => {
    test('Should create correct string', () => {
        ...
        expect(nip.result).toEqual('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus.');
    ...
    test('Should create correct string without white spaces', () => {
        ...
        expect(nip.result).toEqual('Loremipsumdolorsitamet,consecteturadipiscingelit.Sednonrisus.');
        expect(typeof nip.result).toBe('string');
    });
});
