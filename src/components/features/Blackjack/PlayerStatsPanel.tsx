...
const PlayerStatsPanel: FC = () => {
	...
	return (
		<div className="bg-pistachio dark:bg-zinc-500 dark:text-pistachio shadow-xl text-sm lg:text-base text-center font-bold text-green-dark rounded p-3 space-y-3">
